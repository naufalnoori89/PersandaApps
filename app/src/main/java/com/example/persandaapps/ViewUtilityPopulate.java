...
public class ViewUtilityPopulate extends AppCompatActivity{
    ...
    String methodAPI = "?action=getUtility&paymentMonth=" + ViewUtility.nameMonthUtility +"&paymentYear=" + ViewUtility.nameYearUtility;
    ...
    private void queryItemsJson(){
        ...
        System.out.println("Retrieving info (nameMonth): " + ViewUtility.nameMonthUtility);
        System.out.println("Retrieving info (nameYear): " + ViewUtility.nameYearUtility);
        ...
        JsonObjectRequest request =new JsonObjectRequest(Request.Method.GET, url, null, new Response.Listener<JSONObject>() {
            ...
            public void onResponse(JSONObject response) {
                if (response.toString().contains("noData")){
                    loading.dismiss();
                    finish();
                    Toast.makeText(ViewUtilityPopulate.this,"No Payment Based on Your Selection Month: " + ViewUtility.nameMonthUtility +
                            " and Year: " + ViewUtility.nameYearUtility +". Please Select Other Month and Year Combination",Toast.LENGTH_LONG).show();
                ...
                new Response.ErrorListener() {
                    ...
                    public void onErrorResponse(VolleyError error) {
                        finish();
                        Toast.makeText(ViewUtilityPopulate.this,"[ERROR] Unable to Connect to Server",Toast.LENGTH_LONG).show();
    ...
    private void parseJson(JSONObject response) {
        ...
        SimpleAdapter adapter=new SimpleAdapter(this,list,R.layout.list_util_row,from,to);
