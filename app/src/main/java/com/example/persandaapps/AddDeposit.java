...
public class AddDeposit extends AppCompatActivity implements View.OnClickListener{

    EditText editTextAmount;
    Button buttonAddDeposit;
    Spinner dropdown;
    String nameList;
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        dropdown = (Spinner) findViewById(R.id.et_tenant_name_deposit);
        editTextAmount = (EditText)findViewById(R.id.et_deposit_amount);
        getTenantName();
        buttonAddDeposit = (Button)findViewById(R.id.btn_add_deposit);
    ...
    private void addDepositToSheet() {
        final ProgressDialog loading = ProgressDialog.show(this,"Adding Utility Amount","Please wait");
        final String deposit = editTextAmount.getText().toString().trim();


        System.out.println("Starting adding user " + nameList); //QC checkpoint
        System.out.println("Starting update user payment = " + deposit); //QC checkpoint
        ...
        StringRequest stringRequest = new StringRequest(Request.Method.POST, urlBase,
                new Response.Listener<String>() {
                    ...
                    public void onResponse(String postResponse) {
                        loading.dismiss();
                        Toast.makeText(AddDeposit.this,postResponse,Toast.LENGTH_LONG).show();
        ...
        )
        {
            ...
            protected Map<String, String> getParams() {
                ...
                //here we pass params
                parmas.put("action","addDeposit");
                parmas.put("tenantName",nameList);
                parmas.put("amountDeposit",deposit);
