...
public class QueryPayment extends AppCompatActivity {
    ...
    String methodAPI = "?action=queryPaymentJson&paymentMonth=" +SearchPayment.nameMonth +"&paymentYear=" +SearchPayment.nameYear;
    ...
    private void queryItemsJson(){
        ...
        System.out.println("Retrieving info (nameMonth): " + SearchPayment.nameMonth);
        System.out.println("Retrieving info (nameYear): " + SearchPayment.nameYear);
        System.out.println("API: " + url);

      /*  // POST parameters- OBSOLETE
        Map<String, String> paramsHash = new HashMap<String, String>();
        paramsHash.put("action", "queryPaymentJson");
        paramsHash.put("paymentMonth", SearchPayment.nameMonth);
        paramsHash.put("paymentYear", SearchPayment.nameYear);

        JSONObject paramsJson = new JSONObject(paramsHash);
        System.out.println("Parameter for POST: " + paramsHash);*/
        ...
        JsonObjectRequest request =new JsonObjectRequest(Request.Method.GET, url, null, new Response.Listener<JSONObject>() {
            ...
            public void onResponse(JSONObject response) {
                ...
                if (response.toString().contains("noData")){
                    loading.dismiss();
                    finish();
                    Toast.makeText(QueryPayment.this,"No Payment Based on Your Selection Month: " + SearchPayment.nameMonth +
                            " and Year: " + SearchPayment.nameYear +". Please Select Other Month and Year Combination",Toast.LENGTH_LONG).show();
                ...
                new Response.ErrorListener() {
                    ...
                    public void onErrorResponse(VolleyError error) {
                        finish();
                        Toast.makeText(QueryPayment.this,"[ERROR] Unable to Connect to Server",Toast.LENGTH_LONG).show();
