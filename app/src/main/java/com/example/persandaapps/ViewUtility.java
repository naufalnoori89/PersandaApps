...
public class ViewUtility extends AppCompatActivity implements View.OnClickListener{

    Button buttonSearchUtility;
    Spinner dropdownMonth;
    Spinner dropdownYear;
    static String nameMonthUtility;
    static String nameYearUtility;
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        setContentView(R.layout.view_utility);

        dropdownMonth = (Spinner) findViewById(R.id.et_month_util);
        dropdownYear = (Spinner) findViewById(R.id.et_year_util);
        getMonth();
        getYear();
        buttonSearchUtility = (Button)findViewById(R.id.btn_search_util);
        buttonSearchUtility.setOnClickListener(this);
    }
            ...
            public void onResponse(JSONObject getResponse) {
                ...
                new Response.ErrorListener() {
                    ...
                    public void onErrorResponse(VolleyError error) {
                        finish();
                        Toast.makeText(ViewUtility.this,"[ERROR] Unable to Connect to Server",Toast.LENGTH_LONG).show();
    ...
    private void parseMonthList(JSONObject jsonResponse){
        ...
        dropdownMonth.setOnItemSelectedListener(new AdapterView.OnItemSelectedListener(){
            ...
            public void onItemSelected(AdapterView<?> selected, View v, int position, long id) {
                ...
                nameMonthUtility = selected.getItemAtPosition(position).toString().trim();
                //Temp: create toast
                Toast.makeText(getApplicationContext(),"Month " + nameMonthUtility + " is selected", Toast.LENGTH_SHORT).show();
            }
    ...
    private void parseYearList(JSONObject jsonResponse){
        ...
        dropdownYear.setOnItemSelectedListener(new AdapterView.OnItemSelectedListener(){
            ...
            public void onItemSelected(AdapterView<?> selected, View v, int position, long id) {
                ...
                //On selecting spinner item
                nameYearUtility = selected.getItemAtPosition(position).toString().trim();
                //Temp: create toast
                Toast.makeText(getApplicationContext(),"Year " + nameYearUtility + " selected.", Toast.LENGTH_SHORT).show();
            }
    ...
    public void onClick(View v) {
        if(v==buttonSearchUtility){
            System.out.println("Click Vie Utility");
            Intent intent = new Intent(getApplicationContext(),ViewUtilityPopulate.class);
