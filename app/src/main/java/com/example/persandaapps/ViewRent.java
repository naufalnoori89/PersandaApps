...
public class ViewRent extends AppCompatActivity implements View.OnClickListener{

    Button buttonSearchRent;
    Spinner dropdownMonth;
    Spinner dropdownYear;
    static String nameMonthRent;
    static String nameYearRent;
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        dropdownMonth = (Spinner) findViewById(R.id.et_month_rent);
        dropdownYear = (Spinner) findViewById(R.id.et_year_rent);
        getMonth();
        getYear();
        buttonSearchRent = (Button)findViewById(R.id.btn_search_rent);
        buttonSearchRent.setOnClickListener(this);
    }
            ...
            public void onResponse(JSONObject getResponse) {
                ...
                new Response.ErrorListener() {
                    ...
                    public void onErrorResponse(VolleyError error) {
                        finish();
                        Toast.makeText(ViewRent.this,"[ERROR] Unable to Connect to Server",Toast.LENGTH_LONG).show();
    ...
    private void parseMonthList(JSONObject jsonResponse){
        ...
        dropdownMonth.setOnItemSelectedListener(new AdapterView.OnItemSelectedListener(){
            ...
            public void onItemSelected(AdapterView<?> selected, View v, int position, long id) {
                ...
                nameMonthRent = selected.getItemAtPosition(position).toString().trim();
                //Temp: create toast
                Toast.makeText(getApplicationContext(),"This month is selected: "+nameMonthRent, Toast.LENGTH_SHORT).show();
            }
    ...
    private void parseYearList(JSONObject jsonResponse){
        ...
        dropdownYear.setOnItemSelectedListener(new AdapterView.OnItemSelectedListener(){
            ...
            public void onItemSelected(AdapterView<?> selected, View v, int position, long id) {
                ...
                //On selecting spinner item
                nameYearRent = selected.getItemAtPosition(position).toString().trim();
                //Temp: create toast
                Toast.makeText(getApplicationContext(),"This year is selected: "+nameYearRent, Toast.LENGTH_SHORT).show();
            }
    ...
    public void onClick(View v) {
        if(v==buttonSearchRent){
            System.out.println("Click query payment");
            Intent intent = new Intent(getApplicationContext(),ViewRentPopulate.class);
